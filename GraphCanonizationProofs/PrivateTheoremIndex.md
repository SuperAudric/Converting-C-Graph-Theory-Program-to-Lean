...
| `step2_at_depth_zero_of_rank_le_one` | 1543-1576 | Sanity instance: `Step2_at_depth G P v 0` for rank ≤ 1 schurian scheme graphs. | — |
| `schemePart_at_refl` | 1642-1650 | `schemePart_at G P v k` is reflexive. | — |
| `schemePart_at_symm` | 1652-1662 | `schemePart_at G P v k` is symmetric. | — |
| `schemePart_at_trans` | 1664-1676 | `schemePart_at G P v k` is transitive. | — |
| `step2_converges_at_zero_of_rank_le_one` | 1821-1832 | Sanity check: the convergence framework recovers the rank-≤-1 case at depth 0. | — |
| `schemePart_at_one_adj_to_v` | 1902-1907 | Depth-1 extraction, adj-only specialisation. | — |
| `relOfPairDetByAdjP_of_rank_le_one` | 1968-1992 | `rank ≤ 1` schurian scheme graphs trivially satisfy depth-1 separation. | — |
| `adjSeparates_of_rank_le_one` | 2068-2079 | `rank ≤ 1` ⇒ `AdjSeparatesRelations` (≤ 1 non-diagonal index). | — |
