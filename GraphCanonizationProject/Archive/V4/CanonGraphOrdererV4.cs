...
namespace Canonizer
{
    ...
    // NOTE: the `AdjMatrix` class lives in `GraphCanonizationProject/AdjMatrix.cs`
    // (extracted from this file when V4 was archived, since active code in the
    // main project also depends on it). When this file was the canonical
    // implementation it defined AdjMatrix inline — that definition is now gone.
