...
-- deck2: the two-seed supply (this is the one that fired on C5)
#eval ("deck2", (gens (Deck2.deck2Supply (n := 24)) g root).length,
                (verified (Deck2.deck2Supply (n := 24)) g root).length,
                repsOf (Deck2.deck2Supply (n := 24)))
end VTSupply2
