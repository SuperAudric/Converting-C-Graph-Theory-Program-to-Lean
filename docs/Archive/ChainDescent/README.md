...
## Superseded authoritative docs

| Doc | Status | Live home of the conclusion |
|---|---|---|
| `chain-descent-lean-proving-guide-v1.md` | **ARCHIVED 2026-06-04** — was `GraphCanonizationProofs/ChainDescent.md`, the original "self-contained" Lean proving guide. Predates de-classing / Part A / unified oracle (no mention of any); §7 "Proof state" and §10 "Future work" are stale dated logs. | Durable modelling content distilled into [`GraphCanonizationProofs/ChainDescent/README.md`](../../../GraphCanonizationProofs/ChainDescent/README.md); proof state in [`PublicTheoremIndex.md`](../../../GraphCanonizationProofs/PublicTheoremIndex.md); architecture in [`chain-descent-declassing.md`](../../chain-descent-declassing.md). Lean docstrings still cite its `§N` numbers. |
| `chain-descent-simplified-overview-v1.md` | **ARCHIVED 2026-06-04** — the gentle plain-language intro. Its conceptual content (idea, IR tree, true/false symmetry, worked example, honest framing) was folded into the entry-point doc; its §6–§7 oracle framing was pre-fold (two-oracle / order-model). | [`docs/00-START-HERE.md`](../../00-START-HERE.md) §1 (the idea) + [`chain-descent-declassing.md`](../../chain-descent-declassing.md) (current oracle). |
| `chain-descent-orbit-recovery-v1.md` | **ARCHIVED 2026-06-04** — the full 1778-line chronological orbit-recovery research log (per-class tier ladder, Lean formalization phase logs, open-question queues). Superseded as a *plan* by de-classing; ~78% historical narrative. | Live witness theorems kept in the trimmed [`chain-descent-orbit-recovery.md`](../../chain-descent-orbit-recovery.md); current approach in [`chain-descent-declassing.md`](../../chain-descent-declassing.md). |
